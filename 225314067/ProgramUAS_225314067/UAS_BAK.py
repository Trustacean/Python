...
class KaraokeProject():
    def __init__(self,master):
        ...
        self.mainbg = PhotoImage(file='UAS\\main.png')
        self.selectionbg = PhotoImage(file='UAS\\selection.png')
        self.paymentbg = PhotoImage(file='UAS\\payment.png')
        self.submitimg = PhotoImage(file='UAS\\submit.png')
        self.playimg = PhotoImage(file='UAS\\play.png')
        self.pauseimg = PhotoImage(file='UAS\\pause.png')
        self.stopimg = PhotoImage(file='UAS\\stop.png')
        os.chdir("UAS\\music")
